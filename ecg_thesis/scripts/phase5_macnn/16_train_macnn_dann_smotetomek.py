...
def main() -> None:
    ...
    summary["source_init_checkpoint"] = config["dann"].get("source_init_checkpoint")
    summary["target_unlabeled"] = str(cfg_path(config, "data", "target_unlabeled"))
    summary["target_heldout_not_used_for_training"] = str(cfg_path(config, "data", "target_test"))
