...
from src.training.train_daeac_hybrid_mkmmd import train_daeac_hybrid_mkmmd
...
def main() -> None:
    ...
    parser.add_argument("--config", default="configs/phase6_daeac_hybrid_mkmmd.yaml")
    ...
    summary = train_daeac_hybrid_mkmmd(source_ds, val_ds, target_ds, config, output, device)
    write_json(summary, output / "metrics" / "daeac_hybrid_mkmmd_train_summary.json")
