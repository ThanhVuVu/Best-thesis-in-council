...
def main() -> None:
    ...
    names = {
        ...
        "source_train": "source_only_catnet_train_summary.json",
        "source_mitbih": "source_only_catnet_mitbih_test_metrics.json",
        "source_incart": "source_only_catnet_incart_heldout_metrics.json",
