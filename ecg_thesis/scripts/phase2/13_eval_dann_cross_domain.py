...
def main() -> None:
    ...
    parser.add_argument("--checkpoint", default="outputs/checkpoints/dann_best.pt")
    ...
    evaluate_and_save(model, dataset, device, output, name, "dann")
