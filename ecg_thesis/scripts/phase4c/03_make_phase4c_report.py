...
def main() -> None:
    ...
    data = {
        ...
        "phase4c_train": _optional(metrics_dir / "ecgfm_top2_sourcefree_train_summary.json"),
        "phase4c_mitbih": _optional(metrics_dir / "ecgfm_top2_sourcefree_mitbih_test_metrics.json"),
        "phase4c_incart": _optional(metrics_dir / "ecgfm_top2_sourcefree_incart_heldout_metrics.json"),
    }

    lines = [
        "# Phase 4C ECG-FM Top-2 Source-Free Report",
        "",
        "## Train Summary",
        _json_block(data["phase4c_train"]),
        "",
        "## Evaluation",
        _format_metrics(data["phase4c_mitbih"], "MIT-BIH test"),
        "",
        _format_metrics(data["phase4c_incart"], "INCART held-out"),
        "",
        "## Phase 4B -> 4C Delta",
        _comparison(data["phase4b_incart"], data["phase4c_incart"]),
        "",
        "## Phase 4A -> 4C Delta",
        _comparison(data["phase4a_incart"], data["phase4c_incart"]),
        "",
    ]
    report_path = output / "phase4c_ecgfm_top2_sourcefree_report.md"
